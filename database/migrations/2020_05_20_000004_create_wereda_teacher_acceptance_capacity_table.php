...
class CreateweredateacheracceptancecapacityTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('wereda_teacher_acceptance_capacity', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('wereda_teacher_acceptance_capacity');
    }
}
