...
class CreatetransferrequestsfromweredatoweredaTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('transfer_requests_from_wereda_to_wereda', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->integer('fromWeredaId');
            $table->integer('toWeredaId');
            $table->string('date');
    ...
    {
        Schema::dropIfExists('transfer_requests_from_wereda_to_wereda');
    }
}
