<div class="col-md-12">
  <div class="col-md-8">
    {{Form::model($subject, array("route"=>["subjects.update", $subject->id], "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('subjects.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading"> 
        {{App\Global_var::getLangString('Edit_Subject', $language_strings)}}
