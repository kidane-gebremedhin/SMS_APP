...
<hr>
	...
	<a href="{{route('recipients.edit', $recipient->id)}}" value="{{$recipient->id}}" class="get btn btn-sm btn-primary" nextUrl="{{route('recipients.edit', $recipient->id)}}"><i class="fa fa-edit"></i> 

		{{App\Global_var::getLangString('Edit', $language_strings)}}

	</a>

	<a href="{{route('recipients.delete', $recipient->id)}}" value="{{$recipient->id}}" class="get btn btn-sm btn-danger" nextUrl="{{route('recipients.delete', $recipient->id)}}"><i class="fa fa-trash"></i> 
