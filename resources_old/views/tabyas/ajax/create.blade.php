<div class="col-md-12">
  <div class="col-md-8">
   {{Form::open(array("route"=>"tabyas.store", "method"=>"POST", "class"=>"post"))}}
   <label class="nextUrl" nextUrl="{{route('tabyas.index')}}" />
   <div class="panel panel-info">
    <div class="panel-heading">
     <h4>
       {{App\Global_var::getLangString('Create_New_Tabya', $language_strings)}}
       <a href="{{route('tabyas.index')}}" class="get btn btn-success btn-sm pull-right" nextUrl="{{route('tabyas.index')}}"><i class="fa fa-eye"></i>
        <strong>{{App\Global_var::getLangString('List', $language_strings)}} </strong></a> </h4>
      </div>
      <div class="panel-body">
        <div class="col-md-10" style="padding-top:5px;">
          <div class="col-md-10 form-group">
           <label class="label-control col-md-4">{{App\Global_var::getLangString('Region', $language_strings)}}
           </label>
           <div class="col-md-8">
