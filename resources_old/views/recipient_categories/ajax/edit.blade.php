<div class="col-md-12">
  ...
  <div class="col-md-8">
    ...
    {{Form::model($recipient_category, array("route"=>["recipient_categories.update", $recipient_category->id], "method"=>"POST", "class"=>"post"))}}

    <label class="nextUrl" nextUrl="{{route('recipient_categories.index')}}" />

    <div class="panel panel-success">

      <div class="panel-heading"> 

        {{App\Global_var::getLangString('Edit_Recipient_Category', $language_strings)}}
