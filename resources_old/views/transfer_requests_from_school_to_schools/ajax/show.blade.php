...
<hr>
	...
	<a href="{{route('transfer_requests_from_school_to_schools.edit', $transfer_requests_from_school_to_school->id)}}" value="{{$transfer_requests_from_school_to_school->id}}" class="get btn btn-sm btn-primary" nextUrl="{{route('transfer_requests_from_school_to_schools.edit', $transfer_requests_from_school_to_school->id)}}"><i class="fa fa-edit"></i> 
