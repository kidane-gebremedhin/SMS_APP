<div class="col-md-12">
  ...
  <div class="col-md-8">
    ...
    <h4 class="text-danger">
      ...
      <a href="{{route('measurment_types.index')}}" class="get btn btn-default btn-sm" nextUrl="{{route('measurment_types.destroy', $measurment_type->id)}}"> 

        {{App\Global_var::getLangString('No', $language_strings)}}

      </a>

      <a href="{{route('measurment_types.destroy', $measurment_type->id)}}" value="{{$measurment_type->id}}" class="get btn btn-danger btn-sm" nextUrl="{{route('measurment_types.index')}}"><i class="fa fa-trash"></i> 
