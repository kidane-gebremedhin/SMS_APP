<div class="col-md-12">
  <div class="col-md-8">
    {{Form::model($job, array("route"=>["jobs.update", $job->id], "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('jobs.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading"> 
        {{App\Global_var::getLangString('Edit_Job', $language_strings)}}
