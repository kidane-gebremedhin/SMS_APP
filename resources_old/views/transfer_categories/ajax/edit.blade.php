<div class="col-md-12">
  <div class="col-md-8">
    {{Form::model($transfer_category, array("route"=>["transfer_categories.update", $transfer_category->id], "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('transfer_categories.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading"> 
        {{App\Global_var::getLangString('Edit_Transfer_Category', $language_strings)}}
      ...
      <div class="panel-body">
        <div class="col-md-12" style="padding-top:15px;">
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="col-md-8">
              {!!  Form::select('priority', [null=>'-- --']+$integers, null, array('class'=>'select2 form-control', 'required'=>'true')) !!}
            </div>
          </div>
          <div class="col-md-12 form-group">
            <label class="label-control col-md-4">
            ...
            <div class="col-md-8">
              {!!  Form::select('level', [null=>'-- --']+$integers, null, array('class'=>'select2 form-control', 'required'=>'true')) !!}
            </div>
          </div>
          <div class="col-md-12 form-group">
