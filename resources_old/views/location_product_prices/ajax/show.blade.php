...
<hr>
  ...
  <a href="{{route('location_product_prices.edit', $location_product_price->id)}}" value="{{$location_product_price->id}}" class="get btn btn-sm btn-primary" nextUrl="{{route('location_product_prices.edit', $location_product_price->id)}}"><i class="fa fa-edit"></i> 

    {{App\Global_var::getLangString('Edit', $language_strings)}}

  </a>

  <a href="{{route('location_product_prices.delete', $location_product_price->id)}}" value="{{$location_product_price->id}}" class="get btn btn-sm btn-danger" nextUrl="{{route('location_product_prices.delete', $location_product_price->id)}}"><i class="fa fa-trash"></i> 
