<div class="col-md-12">
  <div class="col-md-10">
    {!! Form::open(array("route"=>"wereda_teacher_acceptance_capacities.store", "method"=>"POST", "class"=>"post")) !!}
    <label class="nextUrl" nextUrl="{!! route('wereda_teacher_acceptance_capacities.index') !!}" />
    <div class="panel panel-success">
      <div class="panel-heading">
        {!! App\Global_var::getLangString('Create_new_wereda_teacher_acceptance_capacities', $language_strings) !!}
