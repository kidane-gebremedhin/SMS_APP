   ...
   <div class="panel panel-success">
    <div class="panel-heading">
     ...
     <div class="panel-body">
        ...
        <div class="col-md-12 form-group" style="display: {{$currentUser->isRegion() || $currentUser->isZone() || $currentUser->isWereda()? 'none': 'block'}}">
        ...
        <div class="col-md-12 form-group" style="display: {{$currentUser->isZone() || $currentUser->isWereda()? 'none': 'block'}}">
       ...
       <div class="col-md-12 form-group">
         <label class="label-control col-md-4">{{App\Global_var::getLangString('Office_Head', $language_strings)}}</label>
         <div class="col-md-8">
           {{ Form::text('officeHead', null, array('class'=>'form-control'))}}
         </div>
       </div>
       <div class="col-md-12 form-group">
       ...
       <div class="col-md-12 form-group">
         ...
         <div class="col-md-8">
            <input name="isEthinic" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="mini" class="checkbox" type="checkbox" {{$wereda->isEthinic=='true'? 'checked':''}}> <label>{{App\Global_var::getLangString('Ethinic', $language_strings)}}</label>
         </div>
       </div>
       <div class="col-md-12 form-group">
