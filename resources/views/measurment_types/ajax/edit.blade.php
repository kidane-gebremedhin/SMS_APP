<div class="col-md-12">
  ...
  <div class="col-md-8">
    ...
    {{Form::model($measurment_type, array("route"=>["measurment_types.update", $measurment_type->id], "method"=>"POST", "class"=>"post"))}}

    <label class="nextUrl" nextUrl="{{route('measurment_types.index')}}" />

    <div class="panel panel-success">

      <div class="panel-heading"> 

        {{App\Global_var::getLangString('Edit_Measurment_Type', $language_strings)}}
