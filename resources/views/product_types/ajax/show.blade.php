        ...
        <div class="panel-body">
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong>{{App\Global_var::getLangString('Minimum_Price', $language_strings)}}</strong></td><td><h4>{{$product_type->minPrice}}</h4></td>
                    </tr>
                    <tr>
                        <td><strong>{{App\Global_var::getLangString('Maximam_Price', $language_strings)}}</strong></td><td><h4>{{$product_type->maxPrice}}</h4></td>
                    </tr>
                    <tr>
