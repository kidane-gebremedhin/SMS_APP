  ...
  <div class="col-md-12">
    <div class="col-md-12 panel panel-success">
      ...
      <h3 align="center">{{App\Global_var::getLangString('Export_To_Excel/PDF', $language_strings)}} &nbsp; &nbsp; &nbsp; 
        ...
        <a href="{{ route('receivedSmsReportExel', ['csv']) }}" class="btn btn-success pull-right" style="margin-left: 10px"><i class="fa fa-download"></i> <!--CSV-->Excel
      ...
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>{{!is_array($message['Content'])? $message['Content']:  ''}}</td>
          </tr>
          @endforeach
        </tbody>
      </table>
