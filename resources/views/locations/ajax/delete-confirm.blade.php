<div class="col-md-12">
  ...
  <div class="col-md-8">
    ...
    <h4 class="text-danger">
      ...
      <a href="{{route('locations.index')}}" class="get btn btn-default btn-sm" nextUrl="{{route('locations.destroy', $location->id)}}"> 

        {{App\Global_var::getLangString('No', $language_strings)}}

      </a>

      <a href="{{route('locations.destroy', $location->id)}}" value="{{$location->id}}" class="get btn btn-danger btn-sm" nextUrl="{{route('locations.index')}}"><i class="fa fa-trash"></i> 
