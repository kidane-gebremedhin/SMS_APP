<div class="col-md-12">
  ...
  <div class="col-md-8">
    ...
    {{Form::model($location, array("route"=>["locations.update", $location->id], "method"=>"POST", "class"=>"post"))}}

    <label class="nextUrl" nextUrl="{{route('locations.index')}}" />

    <div class="panel panel-success">

      <div class="panel-heading"> 

        {{App\Global_var::getLangString('Edit_Location', $language_strings)}}
