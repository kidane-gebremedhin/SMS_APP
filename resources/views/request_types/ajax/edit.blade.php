<div class="col-md-12">
  <div class="col-md-8">
    {{Form::model($request_type, array("route"=>["request_types.update", $request_type->id], "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('request_types.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading"> 
        {{App\Global_var::getLangString('Edit_Request_Type', $language_strings)}}
