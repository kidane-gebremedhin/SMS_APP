<div class="col-md-12">
  <div class="col-md-10">
    {!! Form::open(array("route"=>"school_teacher_acceptance_capacities.store", "method"=>"POST", "class"=>"post")) !!}
    <label class="nextUrl" nextUrl="{!! route('school_teacher_acceptance_capacities.index') !!}" />
    <div class="panel panel-success">
      <div class="panel-heading">
        {!! App\Global_var::getLangString('Create_new_school_teacher_acceptance_capacities', $language_strings) !!}
