...
<hr>
	...
	@if($currentUser->isGranted('school_teacher_acceptance_capacities.edit'))
	<a href="{{route('school_teacher_acceptance_capacities.edit', $school_teacher_acceptance_capacity->id)}}" value="{{$school_teacher_acceptance_capacity->id}}" class="get btn btn-sm btn-primary" nextUrl="{{route('school_teacher_acceptance_capacities.edit', $school_teacher_acceptance_capacity->id)}}"><i class="fa fa-edit"></i> 
		{{App\Global_var::getLangString('Edit', $language_strings)}}
	</a>
	@endif
	@if($currentUser->isGranted('school_teacher_acceptance_capacities.delete'))
	<a href="{{route('school_teacher_acceptance_capacities.delete', $school_teacher_acceptance_capacity->id)}}" value="{{$school_teacher_acceptance_capacity->id}}" class="get btn btn-sm btn-danger" nextUrl="{{route('school_teacher_acceptance_capacities.delete', $school_teacher_acceptance_capacity->id)}}"><i class="fa fa-trash"></i> 
