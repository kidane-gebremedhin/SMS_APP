<div class="col-md-12">
	<div class="col-md-8">
		<h4 class="text-danger">
			...
			<a href="{{route('jobs.index')}}" class="get btn btn-default btn-sm" nextUrl="{{route('jobs.destroy', $job->id)}}"> 
				{{App\Global_var::getLangString('No', $language_strings)}}
			</a>
			<a href="{{route('jobs.destroy', $job->id)}}" value="{{$job->id}}" class="get btn btn-danger btn-sm" nextUrl="{{route('jobs.index')}}"><i class="fa fa-trash"></i> 
