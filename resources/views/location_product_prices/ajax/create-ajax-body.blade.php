      ...
      <table class="table table-striped table-hover">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
<div class="col-md-4">{!!  Form::text('price_'.$location->id, App\location_product_price::productLocationPrice($product_type->id, $location->id, $round->id), array('class'=>'priceValue number form-control', 'required'=>'true', 'minValue'=>$product_type->minPrice, 'maxValue'=>$product_type->maxPrice)) !!} </div>
            </td>
            <!--<td>
