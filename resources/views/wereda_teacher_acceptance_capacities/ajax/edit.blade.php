<div class="col-md-12">
  <div class="col-md-10">
    {{Form::model($wereda_teacher_acceptance_capacity, array("route"=>["wereda_teacher_acceptance_capacities.update", $wereda_teacher_acceptance_capacity->id], "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('wereda_teacher_acceptance_capacities.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading"> 
        {{App\Global_var::getLangString('Edit_wereda_teacher_acceptance_capacity', $language_strings)}}
      ...
      <div class="panel-body">
        <div class="col-md-12" style="padding-top:15px;">
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="col-md-8">
            {!! Form::select('weredaId', [null=>'-- --']+$weredas,$currentUser->weredaId, array('class'=>'select2 form-control weredaId', 'required'=>'true'));!!}
            </div>
          </div>
          <div class="col-md-12 form-group">
            <label class="label-control col-md-4">
