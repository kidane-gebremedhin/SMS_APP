...
<hr>
	...
	<a href="{{route('transfer_requests_from_wereda_to_weredas.edit', $transfer_requests_from_wereda_to_wereda->id)}}" value="{{$transfer_requests_from_wereda_to_wereda->id}}" class="get btn btn-sm btn-primary" nextUrl="{{route('transfer_requests_from_wereda_to_weredas.edit', $transfer_requests_from_wereda_to_wereda->id)}}"><i class="fa fa-edit"></i> 
	...
	<a href="{{route('transfer_requests_from_wereda_to_weredas.delete', $transfer_requests_from_wereda_to_wereda->id)}}" value="{{$transfer_requests_from_wereda_to_wereda->id}}" class="get btn btn-sm btn-danger" nextUrl="{{route('transfer_requests_from_wereda_to_weredas.delete', $transfer_requests_from_wereda_to_wereda->id)}}"><i class="fa fa-trash"></i> 
