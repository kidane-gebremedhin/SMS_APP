<div class="col-md-12">
  <div class="col-md-12">
    {!! Form::open(array("route"=>"transfer_requests_from_wereda_to_weredas.store", "method"=>"POST", "files"=>"true", "class"=>"post")) !!}
    <label class="nextUrl" nextUrl="{!! route('transfer_requests_from_wereda_to_weredas.index') !!}"></label>
  ...
  <div class="tab-pane fade in" id="Special_Considerations">
    <div class="col-md-12" style="padding-top:30px;">
          ...
          <div class="col-md-4 form-group">
            ...
            <div class="col-md-12">
            {!! Form::select('merriagePartnerWeredaId', [null=>'-- --']+$weredas,null, array('class'=>'select2 form-control merriagePartnerWeredaId'));!!}
            </div>
          </div>
