<div class="col-md-12">
  <div class="col-md-12">
    {{Form::model($transfer_requests_from_wereda_to_wereda, array("route"=>["transfer_requests_from_wereda_to_weredas.update", $transfer_requests_from_wereda_to_wereda->id], "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('transfer_requests_from_wereda_to_weredas.index')}}" />
    <?php $teacher=$transfer_requests_from_wereda_to_wereda->teacher; ?>
    <div class="panel panel-success">
      <div class="panel-heading">
        <span style="font-size: 25px; color: orange">{!! App\Global_var::getLangString('Create_new_transfer_requests_from_wereda_to_wereda', $language_strings) !!}</span>
...
<div id="myTabContent" class="tab-content">
  ...
  <div class="col-md-12" style="padding-top:30px;">
          ...
          <div class="regularJobIdDiv col-md-12 form-group" style="display: {{$transfer_requests_from_wereda_to_wereda->requestType!=null && $transfer_requests_from_wereda_to_wereda->requestType->name=='Educational Leadership'? 'block':'none'}}">
            <label class="label-control col-md-12">
          ...
          <div class="graduatedSubjectIdDiv col-md-12 form-group" style="display: {{$transfer_requests_from_wereda_to_wereda->requestType!=null && $transfer_requests_from_wereda_to_wereda->requestType->name=='Teacher'? 'block':'none'}}">
            <label class="label-control col-md-12">
          ...
          <div class="teachingSubjectIdDiv col-md-12 form-group" style="display: {{$transfer_requests_from_wereda_to_wereda->requestType!=null && $transfer_requests_from_wereda_to_wereda->requestType->name=='Teacher'? 'block':'none'}};">
            <label class="label-control col-md-12">
    ...
    <div class="col-md-12" style="padding-top:30px;">
        <div class="col-md-12 form-group">
          ...
          <div class="col-md-6">
            ...
            <div class="col-md-12">
              {!!  Form::number('bonusServiceYears', ($transfer_requests_from_wereda_to_wereda->calculatedServiceYears - $transfer_requests_from_wereda_to_wereda->actualServiceYears), array('class'=>'form-control bonusServiceYears', 'min'=>'0', 'max'=>99)) !!}
            </div>
          </div>
          </div>
          <div class="">
          <div class="col-md-6 form-group">
            ...
            <div class="col-md-12">
            {!! Form::select('fromWeredaId', [null=>'-- --']+$weredas,null, array('class'=>'select2 form-control fromWeredaId', 'required'=>'true'));!!}
            </div>
          </div>
          <div class="col-md-6 form-group">
            <label class="label-control col-md-12">
            ...
            <div class="col-md-12">
            {!! Form::select('toWeredaId', [null=>'-- --']+$weredas,null, array('class'=>'select2 form-control toWeredaId', 'required'=>'true'));!!}
            </div>
          </div>
          </div>
    ...
    <div class="col-md-12" style="padding-top:30px;">
        ...
        <div class="col-md-12 form-group">
          ...
          <div class="col-md-4 form-group">
            ...
            <div class="col-md-12 form-group">
            <br>
              <input name="isWillingToTransferAlone" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="mini" class="checkbox" type="checkbox" {{$transfer_requests_from_wereda_to_wereda->isWillingToTransferAlone=='true'? 'checked':''}}> <label>{{App\Global_var::getLangString('Willing_to_transfer_alone', $language_strings)}}</label>
            </div>
          </div>

          <div class="col-md-4 form-group">
            <label class="label-control col-md-12">
              {!! App\Global_var::getLangString('Partner_Wereda', $language_strings) !!}
            </label>
            <div class="col-md-12">
            {!! Form::select('merriagePartnerWeredaId', [null=>'-- --']+$weredas,$teacher!=null? $teacher->merriagePartnerWeredaId: null, array('class'=>'select2 form-control merriagePartnerWeredaId'));!!}
            </div>
          </div>
          ...
          <div class="col-md-4 form-group">
            ...
            <br>
            <span><a href="{{ asset($transfer_requests_from_wereda_to_wereda->teacher->marriageInfoAttachement)}}" target="_blank">{{ count($arr=explode('/', $transfer_requests_from_wereda_to_wereda->teacher->marriageInfoAttachement))==3? $arr[2]: ''}}</a></span>
            </div>
          </div> 
          ...
          <div class="col-md-12 form-group">
            ...
            <div class="col-md-12">
            <input name="isEthinic" data-toggle="toggle" data-onstyle="success" data-offstyle="danger" data-size="mini" class="checkbox" type="checkbox" {{$transfer_requests_from_wereda_to_wereda->isEthinic=='true'? 'checked':''}}> <label>{{App\Global_var::getLangString('Ethinic', $language_strings)}}</label>
            </div>
          </div>
