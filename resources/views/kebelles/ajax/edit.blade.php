<div class="col-md-12">
  <div class="col-md-8">
    {!!Form::model($kebelle, array("route"=>["kebelles.update", $kebelle->id], "method"=>"POST", "class"=>"post"))!!}
    <label class="nextUrl" nextUrl="{{route('kebelles.index')}}" />

    <div class="panel panel-info">
      <div class="panel-heading">
        <h4> {{App\Global_var::getLangString('Kebelle', $language_strings)}} {{App\Global_var::getLangString('Edit', $language_strings)}} 
          <a href="{{route('kebelles.index')}}" class="get btn btn-success btn-sm pull-right" nextUrl="{{route('kebelles.index')}}"><i class="fa fa-eye"></i> <strong>{{App\Global_var::getLangString('List', $language_strings)}}</strong></a> </h4>
        </div>           
