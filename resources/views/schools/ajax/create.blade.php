<div class="col-md-12">
  <div class="col-md-10">
   {{Form::open(array("route"=>"schools.store", "method"=>"POST", "class"=>"post"))}}
   <label class="nextUrl" nextUrl="{{route('schools.index')}}" />
   <div class="panel panel-success">
    <div class="panel-heading">
      <h4>
       {{App\Global_var::getLangString('Create_New_School', $language_strings)}}
       <a href="{{route('schools.index')}}" class="get btn btn-success btn-sm pull-right"><i class="fa fa-eye"></i> 
