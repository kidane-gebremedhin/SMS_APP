<div class="col-md-12">
	<div class="col-md-8">
		<h4 class="text-danger">
			...
			<a href="{{route('educational_levels.index')}}" class="get btn btn-default btn-sm" nextUrl="{{route('educational_levels.destroy', $educational_level->id)}}"> 
				{{App\Global_var::getLangString('No', $language_strings)}}
			</a>
			<a href="{{route('educational_levels.destroy', $educational_level->id)}}" value="{{$educational_level->id}}" class="get btn btn-danger btn-sm" nextUrl="{{route('educational_levels.index')}}"><i class="fa fa-trash"></i> 
