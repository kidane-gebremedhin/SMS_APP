<div class="col-md-12">
  <div class="col-md-8">
    {{Form::model($educational_level, array("route"=>["educational_levels.update", $educational_level->id], "method"=>"POST", "class"=>"post"))}}
    <label class="nextUrl" nextUrl="{{route('educational_levels.index')}}" />
    <div class="panel panel-success">
      <div class="panel-heading"> 
        {{App\Global_var::getLangString('Edit_Educational_Level', $language_strings)}}
